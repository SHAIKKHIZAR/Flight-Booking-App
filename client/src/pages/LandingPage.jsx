    ...
    <div className="landingPage">
        <div className="landingHero">
          ...
          <div className="landingHero-title">
            <h1 className="banner-h1">Your Journey Begins Here – Discover and Book Flights with Ease!</h1>
        ...
        <div className="container">
            ...
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; Welcome aboard! Plan your next adventure with ease — from quick trips to dream getaways, we’ve got the flights to take you where you want to go.


            </p>
            <p className="section-description">
                &nbsp; &nbsp;&nbsp; &nbsp; We prioritize convenience and efficiency in your travel experience. With our easy-to-use interface, you can quickly browse flight schedules, compare fares, and book the best seats — all in just a few clicks. Customize your journey by choosing departure times, seat preferences, and special requests with ease.
            </p>
            <p className="section-description">
            ...
            <span><h5>2025 MS FlightConnect - &copy; Happy flying!</h5></span>
